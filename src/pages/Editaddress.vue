<template>
  <div class="content">
    <div class="head">
      <img class="cancelicon" v-on:click="Cancel" src="../assets/images/cancel.png">编辑地址
    </div>
    ...
    <div class="deletebtn" v-on:click="Delete">删除</div>
      ...
      if (/^1(3|4|5|6|7|8|9)\d{9}$/.test(this.list.emsPhone)) {
        axios
          ...
          .then(resp => {
            ...
            this.$router.replace({ path: "/Selectaddress" ,query:{msg:this.msg,id:1}});
          });
      } else {
        Toast("请输入正确的手机号");
      }
