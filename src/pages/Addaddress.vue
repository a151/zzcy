<template>
  <div class="content">
    <div class="head">
      <img class="cancelicon" v-on:click="Cancel" src="../assets/images/cancel.png" />添加地址
    </div>
    <div class="remark" v-show="isMsg">必填！不填写无法认种成功！</div>
    <div class="list">
      <div class="info">
    ...
    <div class="sure" v-on:click="Submit">确定</div>
  </div>
</template>
<script>
